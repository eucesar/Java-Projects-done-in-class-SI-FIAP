...
public class AutenticarControle extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usuario != null && "admin".equalsIgnoreCase(usuario.getPerfil().getPerfil())) {
			...
			session.setAttribute(senha, usuario.getNome()); //mandando senha e usuario
			response.sendRedirect("admin/dashboard.jsp"); //abra a pagina do dashbord - enviando arquivo
		}
	}
