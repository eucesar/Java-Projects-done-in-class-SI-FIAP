...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (Empregado e : empregado) {
			System.out.println(e); //quando vc so coloca a variavel de referencia, ele escreve o toString() - e.toString()
			System.out.println(e.calcularSalario()); //colocar metodos na super class - para que apareça
		}
